...
| Signal ID | Signal Name | Detection Source | Description | Points |
|-----------|-------------|------------------|-------------|--------|
| **DATA_S** | Sensitive Data | Privacy Policy / Docs | Handles PHI, PII, or financial data. | 4 |
| **COMP_L** | Compliance Certs | Security Page / Footer | Mentions SOC2, ISO 27001, HIPAA, GDPR. | 3 |
| **FIN_HEA** | Regulated Vertical | About / LinkedIn | Operates in Finance, Healthcare, or Insurance. | 3 |
