...
from src.scheduler.tasks import run_scraping, run_scoring, run_enrichment, run_outreach, run_inbox_monitoring, run_compliance_sync
...
def main():
    ...
    # 6. Compliance Sync: every 60 minutes
